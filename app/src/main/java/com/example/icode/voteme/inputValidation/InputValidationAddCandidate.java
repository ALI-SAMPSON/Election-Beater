...
public class InputValidationAddCandidate extends AsyncTask<String,Void,String> {
    ...
    public InputValidationAddCandidate(Context ctx){
        context = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        String register_url = "http://10.0.2.2/my_project/RegisterCandidate.php";       //URL to the Php Script for voter Registration
        if(type.equals("register_candidate"))
        {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        progressDialog = ProgressDialog.show(context, "Adding Candidate...", null, true, true);
    }

    @Override
    protected void onPostExecute(String result) {

       // if(result.equalsIgnoreCase("Candidate Added Successfully"))
        //{
